...
class SimpleHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def deal_post_data(self):
        ...
        if content_type_parts is None or len(content_type) <= 1:
            return False, "Content-Type header doesn't contain boundary"
        boundary = content_type_parts[1].encode()
                ...
                with out:
                    ...
                    while remain_bytes > 0:
                        ...
                        if boundary in line:
                            ...
                            out.write(pre_line)
                            pre_line = line
        return True, " ".join(uploaded_files)
    ...
    def list_directory(self, path):
        ...
        for name in list:
            ...
            f.write((
                            ...
                            % (dir_image, urllib.parse.quote(linkname), html.escape(displayname), fsize,
...
parser.add_argument('host', default='0.0.0.0', metavar='host', type=str, nargs='?',
